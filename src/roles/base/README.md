...
| ---------------------------------- | ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`unnecessary_packages`**         | `["games", "ftp", "telnet"]`  | List of packages to remove during initial cleanup. By default, it removes legacy or insecure utilities (games, ftp, telnet) that are generally not needed on servers.                                                      |
